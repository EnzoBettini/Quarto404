<template>
  ...
  <div class="puzzle-container">
    ...
    <button @click="abrirPinPad" class="open-pinpad-button" aria-haspopup="dialog"
      :aria-expanded="pinPadVisivel.toString()">
      ...
      <div class="pinpad-modal" role="dialog" aria-modal="true" @click.stop>
        ...
        <div class="inputs-container">
          ...
          <div v-for="(digit, index) in codigoInput" :key="index" class="digit-control">
            ...
            <button class="arrow-btn" @click="incrementDigit(index)" aria-label="Incrementar dígito">▲</button>

            <div class="digit-display">{{ digit }}</div>

            <button class="arrow-btn" @click="decrementDigit(index)" aria-label="Decrementar dígito">▼</button>
